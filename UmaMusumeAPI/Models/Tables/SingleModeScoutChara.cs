...
{
    public class SingleModeScoutChara
    {
        ...
        public long TagSupportCardId { get; set; }
        ...
        public long StaminaLimit { get; set; }
        public long PowLimit { get; set; }
        public long GutsLimit { get; set; }
        public long WizLimit { get; set; }
    }
}
