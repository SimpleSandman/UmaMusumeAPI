...
{
    [GeneratedController]
    public class DailyLegendRace
    {
        public int Id { get; set; }
        public int GroupId { get; set; }
        public int LegendBgId { get; set; }
        public int LegendBgSubId { get; set; }
        ...
        public int LegendRaceBossNpcId { get; set; }
        public int CostNum { get; set; }
        public int DropRewardOddsId { get; set; }
        public int VictoryRewardOddsId { get; set; }
