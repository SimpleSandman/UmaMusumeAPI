...
(
  ...
  , reward_coin BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 546,
...
(
    id INT(11) NOT NULL
  , score_group_id BIGINT(20) NOT NULL
  , score_type BIGINT(20) NOT NULL
  , data BIGINT(20) NOT NULL
  , disp_order BIGINT(20) NOT NULL
  , bonus_score BIGINT(20) NOT NULL
  , reward_coin BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
...
(
    id INT(11) NOT NULL
  , target_main_scenario BIGINT(20) NOT NULL
  , exam_id_1 BIGINT(20) NOT NULL
  , exam_id_2 BIGINT(20) NOT NULL
  , exam_id_3 BIGINT(20) NOT NULL
  , exam_id_4 BIGINT(20) NOT NULL
  , exam_id_5 BIGINT(20) NOT NULL
  , ex_exam_id BIGINT(20) NOT NULL
  , free_exam_id BIGINT(20) NOT NULL
  , shop_id BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , end_date BIGINT(20) NOT NULL
  , start_result_date BIGINT(20) NOT NULL
  , end_result_date BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
...
(
    id INT(11) NOT NULL
  , feature_type BIGINT(20) NOT NULL
  , good_score BIGINT(20) NOT NULL
  , good_score_reward_coin BIGINT(20) NOT NULL
  , great_score BIGINT(20) NOT NULL
  , great_score_reward_coin BIGINT(20) NOT NULL
  , exellent_score BIGINT(20) NOT NULL
  , exellent_score_reward_coin BIGINT(20) NOT NULL
  , score_group_id BIGINT(20) NOT NULL
...
(
  ...
  , ability_time_usage_1 BIGINT(20) NOT NULL
  ...
  , ability_time_usage_2 BIGINT(20) NOT NULL
...
--
-- Create index `skill_data_skill_data_0_group_id` on table `skill_data`
--
ALTER TABLE skill_data
ADD INDEX skill_data_skill_data_0_group_id (group_id);
...
(
  ...
  , pos_z BIGINT(20) NOT NULL
  , rotation_y BIGINT(20) NOT NULL
  , motion_set_id BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 1365,
...
(
  ...
  , tag_support_card_id BIGINT(20) NOT NULL
  ...
  , speed_limit BIGINT(20) NOT NULL
  , stamina_limit BIGINT(20) NOT NULL
  , pow_limit BIGINT(20) NOT NULL
  , guts_limit BIGINT(20) NOT NULL
  , wiz_limit BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 455,
...
(
    id INT(11) NOT NULL
  , scenario_id BIGINT(20) NOT NULL
  , need_record_min BIGINT(20) NOT NULL
  , reward_item_category BIGINT(20) NOT NULL
  , reward_item_id BIGINT(20) NOT NULL
  , reward_num BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 910,
...
(
    id INT(11) NOT NULL
  , condition_set_id BIGINT(20) NOT NULL
  , condition_type_1 BIGINT(20) NOT NULL
  , condition_value_1 BIGINT(20) NOT NULL
  , condition_value_2 BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
...
(
    id INT(11) NOT NULL
  , route_race_type BIGINT(20) NOT NULL
  , route_race_id BIGINT(20) NOT NULL
  , turn BIGINT(20) NOT NULL
  , target_type BIGINT(20) NOT NULL
  , target_value BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
...
(
  ...
  , effect_group BIGINT(20) NOT NULL
  , effect_priority BIGINT(20) NOT NULL
  , motion_id BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
...
(
  ...
  , effect_value_3 BIGINT(20) NOT NULL
  , effect_value_4 BIGINT(20) NOT NULL
  , turn BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
...
(
    id INT(11) NOT NULL
  , start_turn BIGINT(20) NOT NULL
  , end_turn BIGINT(20) NOT NULL
  , bg_id BIGINT(20) NOT NULL
  , bg_sub_id BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
...
(
  ...
  , start_turn BIGINT(20) NOT NULL
  , end_turn BIGINT(20) NOT NULL
  , lineup_group_id BIGINT(20) NOT NULL
  , max_lineup_num BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
...
(
  ...
  , chara_id BIGINT(20) NOT NULL
  , dress_id BIGINT(20) NOT NULL
  , in_motion BIGINT(20) NOT NULL
  , stand_motion BIGINT(20) NOT NULL
  , play_motion BIGINT(20) NOT NULL
  , gauge_motion BIGINT(20) NOT NULL
  , gauge_motion2 BIGINT(20) NOT NULL
  , gauge_motion3 BIGINT(20) NOT NULL
  , popout_motion BIGINT(20) NOT NULL
  , bgm_cue_name TEXT NOT NULL
  , bgm_cuesheet_name TEXT NOT NULL
  , reward_type BIGINT(20) NOT NULL
  , reward_set_id BIGINT(20) NOT NULL
  , gauge_max BIGINT(20) NOT NULL
  , gauge_up BIGINT(20) NOT NULL
...
(
  ...
  , result_min BIGINT(20) NOT NULL
  , result_max BIGINT(20) NOT NULL
  , gauge_rate BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 3276,
...
(
  ...
  , box_open_condition BIGINT(20) NOT NULL
  , box_type BIGINT(20) NOT NULL
  , box_id BIGINT(20) NOT NULL
...
(
    id INT(11) NOT NULL
  , route_race_group_id BIGINT(20) NOT NULL
  , chara_id BIGINT(20) NOT NULL
  , route_race_id BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
...
(
    id INT(11) NOT NULL
  , offset_1 BIGINT(20) NOT NULL
  , offset_2 BIGINT(20) NOT NULL
  , offset_3 BIGINT(20) NOT NULL
  , offset_4 BIGINT(20) NOT NULL
  , offset_5 BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 3276,
...
(
    id INT(11) NOT NULL
  , turn_num BIGINT(20) NOT NULL
  , notice_turn_1 BIGINT(20) NOT NULL
  , notice_turn_2 BIGINT(20) NOT NULL
  , notice_turn_3 BIGINT(20) NOT NULL
  , notice_turn_4 BIGINT(20) NOT NULL
  , notice_turn_5 BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 3276,
...
(
    id INT(11) NOT NULL
  , team_rank_threshold BIGINT(20) NOT NULL
  , add_status BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 2730,
...
(
  ...
  , request_value BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , end_date BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
...
(
    id INT(11) NOT NULL
  , chara_id BIGINT(20) NOT NULL
  , reaction_chara_id BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , end_date BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
...
(
  ...
  , sort BIGINT(20) NOT NULL
  , condition_type BIGINT(20) NOT NULL
  , is_hidden BIGINT(20) NOT NULL
  , version_type BIGINT(20) NOT NULL
  , request_type BIGINT(20) NOT NULL
  , lamp_color BIGINT(20) NOT NULL
  , lamp_animation BIGINT(20) NOT NULL
  , name_texture_length BIGINT(20) NOT NULL
  , song_type BIGINT(20) NOT NULL
  ...
  , short_length BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , end_date BIGINT(20) NOT NULL
  , PRIMARY KEY (music_id)
)
...
(
  ...
  , chara_id BIGINT(20) NOT NULL
  , comment_type BIGINT(20) NOT NULL
  , variation_type BIGINT(20) NOT NULL
  , variation_value BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 128,
...
(
    chara_id BIGINT(20) NOT NULL
  , body_shape BIGINT(20) NOT NULL
  , prop_id_right BIGINT(20) NOT NULL
  , prop_eat_animation_right TEXT NOT NULL
  , override_motion_right TEXT NOT NULL
  , prop_id_left BIGINT(20) NOT NULL
...
(
    id INT(11) NOT NULL
  , gacha_stock_id BIGINT(20) NOT NULL
  , gacha_id BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , end_date BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
...
(
    id INT(11) NOT NULL
  , retry_min BIGINT(20) NOT NULL
  , retry_max BIGINT(20) NOT NULL
  , bonus_rate BIGINT(20) NOT NULL
  , resimulate_num BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 3276,
...
(
  ...
  , condition_value_2 BIGINT(20) NOT NULL
  , point BIGINT(20) NOT NULL
  , race_point_name_id BIGINT(20) NOT NULL
  , sort_order BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
...
(
    id INT(11) NOT NULL
  , challenge_match_id BIGINT(20) NOT NULL
  , disp_order BIGINT(20) NOT NULL
  , challenge_match_bg_id BIGINT(20) NOT NULL
  , challenge_match_bg_sub_id BIGINT(20) NOT NULL
  , difficulty BIGINT(20) NOT NULL
  , race_type BIGINT(20) NOT NULL
  , race_appearance_rate BIGINT(20) NOT NULL
  , race_instance_id BIGINT(20) NOT NULL
  , season BIGINT(20) NOT NULL
  , weather BIGINT(20) NOT NULL
  , ground BIGINT(20) NOT NULL
  , challenge_match_race_boss_npc_id BIGINT(20) NOT NULL
  , cost_rp BIGINT(20) NOT NULL
  , drop_reward_odds_id BIGINT(20) NOT NULL
  , victory_reward_odds_id BIGINT(20) NOT NULL
  , first_clear_item_category_1 BIGINT(20) NOT NULL
  , first_clear_item_id_1 BIGINT(20) NOT NULL
  ...
  , pick_up_item_id_3 BIGINT(20) NOT NULL
  , pick_up_item_num_3 BIGINT(20) NOT NULL
  , pick_up_item_category_4 BIGINT(20) NOT NULL
  , pick_up_item_id_4 BIGINT(20) NOT NULL
  , pick_up_item_num_4 BIGINT(20) NOT NULL
  , pick_up_item_category_5 BIGINT(20) NOT NULL
  , pick_up_item_id_5 BIGINT(20) NOT NULL
  , pick_up_item_num_5 BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 2730,
...
(
  ...
  , bonus_skill_id BIGINT(20) NOT NULL
  , bonus_factor_id BIGINT(20) NOT NULL
  , item_exchange_top_id BIGINT(20) NOT NULL
  , notice_date BIGINT(20) NOT NULL
  , start_date BIGINT(20) NOT NULL
  , ending_date BIGINT(20) NOT NULL
...
(
    id INT(11) NOT NULL
  , race_additional_reward_id BIGINT(20) NOT NULL
  , item_category BIGINT(20) NOT NULL
  , item_id BIGINT(20) NOT NULL
  , reward_type BIGINT(20) NOT NULL
  , reward_value BIGINT(20) NOT NULL
  , reward_rate BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 1365,
...
(
    id INT(11) NOT NULL
  , race_additional_id BIGINT(20) NOT NULL
  , race_program_id BIGINT(20) NOT NULL
  , race_additional_reward_id BIGINT(20) NOT NULL
  , reward_limit BIGINT(20) NOT NULL
  , PRIMARY KEY (id)
)
ENGINE = INNODB,
AVG_ROW_LENGTH = 4096,
...
CREATE TABLE audience_impostor_color_set
(
    color_group_id BIGINT(20) NOT NULL
  , color TEXT NOT NULL
  , odds BIGINT(20) NOT NULL
)
ENGINE = INNODB,
...
(
  ...
  , weather BIGINT(20) NOT NULL
  , group_id BIGINT(20) NOT NULL
  , pattern_1 BIGINT(20) NOT NULL
  , pattern_2 BIGINT(20) NOT NULL
  , pattern_3 BIGINT(20) NOT NULL
  , pattern_4 BIGINT(20) NOT NULL
  , pattern_5 BIGINT(20) NOT NULL
  , pattern_6 BIGINT(20) NOT NULL
  , pattern_7 BIGINT(20) NOT NULL
  , pattern_8 BIGINT(20) NOT NULL
  , pattern_9 BIGINT(20) NOT NULL
  , pattern_10 BIGINT(20) NOT NULL
)
ENGINE = INNODB,
CHARACTER SET utf8mb4,
COLLATE utf8mb4_general_ci;
...
(
  ...
  , chara_hair_model BIGINT(20) NOT NULL
  , chara_hair_color BIGINT(20) NOT NULL
  , prop_id_1 BIGINT(20) NOT NULL
  , prop_attach_node_name_type_1 BIGINT(20) NOT NULL
  , prop_id_2 BIGINT(20) NOT NULL
  , prop_attach_node_name_type_2 BIGINT(20) NOT NULL
  , chara_height BIGINT(20) NOT NULL
  , shape BIGINT(20) NOT NULL
  , chara_bust_size BIGINT(20) NOT NULL
  , dress_id BIGINT(20) NOT NULL
